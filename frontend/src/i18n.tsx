...
const zh: Dict = {
  ...
  homeSubtitle: '同时向多个模型提问，比较思路，深入每一个值得追问的方向。',
  newQuestion: '新问题',
  settings: '配置',
  searchChats: '搜索聊天记录...',
  searchResult: '搜索结果',
  ...
  collapseGroup: '折叠分组',
  sidebarTimeToday: '今天',
  sidebarTimeYesterday: '昨天',
  sidebarTimeRecent: '近 7 天',
  sidebarTimeThisMonth: '本月',
  justNow: '刚刚',
  ...
  progressionLockedPlaceholder: '返回上级节点来继续创建新节点',
  thinkingDepth: '思考深度',
  ...
  saveSummary: '✓ 保存摘要',
  focusNodeHint: '双击进入此节点',
  focusNode: '聚焦',
  focusReading: '专注阅读',
  exitFocusReading: '退出专注阅读',
  focusReadingProgress: '阅读进度 {progress}%',
  focusReadingResume: '跳到本次最远阅读位置 {progress}%（连续按三次 ↓）',
  focusReadingKeyPoint: '关键点 {progress}%：有效停留 {hits} 次（双击 ↑/↓ 跳转）',
  focusReadingSettings: '阅读设置',
  focusReadingAddKeyPoint: '在当前位置建立关键点',
  focusReadingTextSize: '字体大小',
  focusReadingLevelLow: '小',
  focusReadingLevelMedium: '中',
  focusReadingLevelHigh: '大',
  focusReadingFont: '正文字体',
  focusReadingFontSystem: '系统黑体',
  focusReadingFontModernSans: '现代黑体',
  focusReadingFontBookSerif: '书卷宋体',
  focusReadingFontAcademicSerif: '学术衬线',
  focusReadingContentWidth: '正文宽度',
  focusReadingWidthLow: '窄',
  focusReadingWidthMedium: '标准',
  focusReadingWidthHigh: '宽',
  focusReadingParentNode: '跳回父节点',
  toggleCollapse: '切换折叠',
  toggleCollapseDescendants: '切换折叠（及所有子节点）',
  replies: '回复',
  ...
  account: '通用配置',
  miniMap: '小地图',
  miniMapHint: '在桌面端聊天视图右上角显示问题树缩略图。',
  enabled: '已启用',
  disabled: '已关闭',
  autoSummary: '自动摘要',
  ...
  localMode: '本地模式',
  loginStatus: '登录状态',
  contextMaxChars: '上下文最长长度',
  contextMaxCharsHint: '按字符数截断历史上下文，范围 {min} 到 {max}。默认 20000。',
  ...
  profileAutoUpdateNote: '按账户时区每天凌晨 3 点后更新现实信息，每周更新能力边界与兴趣；停机错过后会自动补跑。自动生成的段落会尽量控制总长度在 800 字符内，且不会截断手写内容。',
  updatedAt: '更新于 {time}',
  notSaved: '尚未保存',
  ...
  overviewBranches: '分支',
  overviewGrowing: '生长中',
  overviewShowFullText: '展示完整文本',
  overviewShowTruncatedText: '展示截断文本',
  overviewZoomIn: '放大总览',
  overviewZoomOut: '缩小总览',
  overviewRecenter: '回到当前节点',
  loadingTree: '⟳ 正在加载问题树...',
...
const en: Dict = {
  ...
  homeSubtitle: 'Ask multiple models, compare their reasoning, and explore every promising direction.',
  ...
  sidebarTimeToday: 'Today',
  sidebarTimeYesterday: 'Yesterday',
  sidebarTimeRecent: 'Last 7 days',
  sidebarTimeThisMonth: 'This month',
  justNow: 'Just now',
  ...
  progressionLockedPlaceholder: 'Return to the parent node to keep creating new nodes',
  ...
  focusNodeHint: 'Enter this node by double clicking',
  focusNode: 'Focus',
  focusReading: 'Focus reading',
  exitFocusReading: 'Exit focus reading',
  focusReadingProgress: 'Reading progress {progress}%',
  focusReadingResume: 'Jump to furthest reading position {progress}% (press ↓ three times)',
  focusReadingKeyPoint: 'Key point {progress}%: {hits} valid visits (press ↑/↓ twice to navigate)',
  focusReadingSettings: 'Reading settings',
  focusReadingAddKeyPoint: 'Add key point here',
  focusReadingTextSize: 'Text size',
  focusReadingLevelLow: 'Small',
  focusReadingLevelMedium: 'Medium',
  focusReadingLevelHigh: 'Large',
  focusReadingFont: 'Body font',
  focusReadingFontSystem: 'System Sans',
  focusReadingFontModernSans: 'Modern Sans',
  focusReadingFontBookSerif: 'Book Serif',
  focusReadingFontAcademicSerif: 'Academic Serif',
  focusReadingContentWidth: 'Content width',
  focusReadingWidthLow: 'Narrow',
  focusReadingWidthMedium: 'Standard',
  focusReadingWidthHigh: 'Wide',
  focusReadingParentNode: 'Go to parent node',
  toggleCollapse: 'Toggle collapse',
  toggleCollapseDescendants: 'Toggle collapse (and all child nodes)',
  replies: 'replies',
  ...
  account: 'General',
  miniMap: 'Mini map',
  miniMapHint: 'Show the question-tree mini map in the top-right of the desktop chat view.',
  enabled: 'Enabled',
  disabled: 'Disabled',
  ...
  contextMaxChars: 'Maximum context length',
  contextMaxCharsHint: 'Historical context is truncated by character count. Range: {min} to {max}. Default: 20000.',
  ...
  profileAutoUpdateNote: 'After 3 AM in your account timezone, it updates real-world notes daily and capabilities and interests weekly. Missed runs are caught up. Generated sections target 800 total characters without truncating handwritten content.',
  ...
  quotePrefix: 'Quote',
  overviewMode: 'Tree overview',
  readingMode: 'Back to reading',
  overviewBranches: 'branches',
  overviewGrowing: 'growing',
  overviewShowFullText: 'Show full text',
  overviewShowTruncatedText: 'Show truncated text',
  overviewZoomIn: 'Zoom in',
  overviewZoomOut: 'Zoom out',
  overviewRecenter: 'Recenter current node',
