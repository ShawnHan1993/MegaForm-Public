...
const zh: Dict = {
  ...
  newGroupName: '输入分组名称',
  renameGroup: '重命名分组',
  deleteGroupConfirm: '删除分组后，其中的对话会移回“对话”。确定删除？',
  moveToGroup: '移动到分组',
  expandGroup: '展开分组',
  collapseGroup: '折叠分组',
  justNow: '刚刚',
  ...
  defaultFollowupExplainMeaning: '解释一下这个含义',
  close: '关闭',
  ...
  immersiveBrowseShort: '沉浸式浏览',
  exitImmersiveBrowse: '退出沉浸式浏览',
  nodeActions: '节点操作',
  addSummary: '添加摘要',
  editAndRerun: '编辑并重跑',
  editContent: '修改内容',
  ...
  account: '账户',
  autoSummary: '自动摘要',
  autoSummaryGenerating: '摘要生成中...',
  autoSummaryModelRequired: '请先在配置中选择自动摘要模型',
  autoSummaryOff: '关闭自动摘要',
  autoSummarySwitcher: '自动生成',
  summaryModelPlaceholder: '选择摘要模型',
  manualSummaryModelHint: '关闭自动生成后，仍可用此模型手动生成摘要',
  ...
  proxyUrlHint: '可选。仅该模型调用 API 时使用，留空则使用系统默认网络。',
  ...
  profileAutoUpdateModel: '自动更新 Profile 的模型',
  profileAutoUpdateOff: '关闭自动更新',
  profileAutoUpdateNote: '每天凌晨 3 点更新现实信息；每周一凌晨 3 点更新能力边界与兴趣。更新后总长度会尽量控制在 800 字符内。',
  updatedAt: '更新于 {time}',
  notSaved: '尚未保存',
...
const en: Dict = {
  ...
  chats: 'Chats',
  newGroup: 'New group',
  newGroupName: 'Enter a group name',
  renameGroup: 'Rename group',
  deleteGroupConfirm: 'Delete this group? Its chats will move back to Chats.',
  ...
  defaultFollowupExplainMeaning: 'Explain what this means',
  close: 'Close',
  ...
  focusNodeHint: 'Enter this node',
  focusNode: 'Focus',
  replies: 'replies',
  immersiveBrowse: 'Immersive reading: hide follow-up branches',
  immersiveBrowseShort: 'Immersive reading',
  exitImmersiveBrowse: 'Exit immersive reading',
  ...
  autoSummaryGenerating: 'Generating summary...',
  autoSummaryModelRequired: 'Choose an auto summary model in settings first',
  autoSummaryOff: 'Disable auto summary',
  autoSummarySwitcher: 'Generate automatically',
  summaryModelPlaceholder: 'Choose summary model',
  manualSummaryModelHint: 'This model can still generate summaries manually when automatic generation is off',
  ...
  proxyUrl: 'Proxy URL',
  proxyUrlPlaceholder: 'http://127.0.0.1:7890',
  proxyUrlHint: 'Optional. Used only when this model calls the API. Leave blank for the default network.',
  ...
  profileAutoUpdateModel: 'Profile auto-update model',
  profileAutoUpdateOff: 'Disable auto-update',
  profileAutoUpdateNote: 'At 3 AM daily it updates real-world notes; at 3 AM every Monday it updates capability boundaries and interests. The profile is kept around 800 characters.',
